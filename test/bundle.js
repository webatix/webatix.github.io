...
var K,X,Z,Q,G,Y;J.finalized=!0,J.shadowRootOptions={mode:"open"},null===(H=(L=globalThis).reactiveElementPlatformSupport)||void 0===H||H.call(L,{ReactiveElement:J}),(null!==(F=(U=globalThis).reactiveElementVersions)&&void 0!==F?F:U.reactiveElementVersions=[]).push("1.0.0-rc.1"),(null!==(K=(Y=globalThis).litElementVersions)&&void 0!==K?K:Y.litElementVersions=[]).push("3.0.0-rc.1");class ee extends J{constructor(){super(...arguments),this.renderOptions={host:this},this.Φt=void 0}createRenderRoot(){var e,t;const o=super.createRenderRoot();return null!==(e=(t=this.renderOptions).renderBefore)&&void 0!==e||(t.renderBefore=o.firstChild),o}update(e){const t=this.render();super.update(e),this.Φt=O(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),null===(e=this.Φt)||void 0===e||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),null===(e=this.Φt)||void 0===e||e.setConnected(!1)}render(){return x}}ee.finalized=!0,ee._$litElement$=!0,null===(Z=(X=globalThis).litElementHydrateSupport)||void 0===Z||Z.call(X,{LitElement:ee}),null===(G=(Q=globalThis).litElementPlatformSupport)||void 0===G||G.call(Q,{LitElement:ee});var te={tab_strip:(e,t,o)=>_`
      ...
      </kor-card>`},ie={Init(e,t,o,n,r,i,s){const c=i.querySelector("kor-card"),a=e=>{O(te.object_entries_two_columns(Object.entries(e.attributes)),c),i.setAttribute("visible","true")},l=async e=>{const o=new Moralis.Query("EthTransactions");o.equalTo("to_address",e.get("ethAddress"));const n=new Moralis.Query("EthTransactions");n.equalTo("from_address",e.get("ethAddress"));let r=await o.find();console.log("Incoming transactions: ",r);let i=await n.find();console.log("Out coming transactions: ",i),O(oe.transactions(r,i,a),t);const c=await o.subscribe(),l=await n.subscribe();c.on("create",(e=>{console.log("A new incoming transaction: ",e),r=r.concat(e),O(oe.transactions(r,i,a),t)})),l.on("create",(e=>{console.log("A new out coming transaction: ",e),i=i.concat(e),O(oe.transactions(r,i,a),t)})),s.web3=await Moralis.Web3.enable(),console.log("web3 == ",s.web3)};return()=>{if(!n.getAttribute("login"))return Moralis.LiveQuery.close(),(async()=>{await Moralis.User.logOut(),O(_``,e),O(_``,t),O(_``,o),console.log("Logged out")})(),n.setAttribute("label","Login using Metamask"),n.setAttribute("login","true"),void(r.style.display="none");Moralis.Web3.authenticate().then((t=>{n.setAttribute("label","Log out"),n.removeAttribute("login"),r.style.display="block",O(te.object_entries_two_columns(Object.entries(t)),e),console.log("The current user: ",t),console.log("The current user password: ",t.password),console.log("The current user's EthAddress: ",t.get("ethAddress")),Moralis.Cloud.run("watchEthAddress",{address:t.get("ethAddress")}).then((e=>{console.log("The watchEthAddress results: ",e),l(t)})).catch((()=>{l(t)}))}))}}};class se{constructor(){this.cached_value_=JSON.parse(window.localStorage.getItem(this.storage_name))}get storage_name(){return"LocalStorageBacked"}}class ce extends se{constructor(){super(),this.cached_value_||(this.cached_value_={})}get storage_name(){return"BookedAddresses"}set value(e){let t={};e.map((e=>{Object.defineProperty(t,e.toString(),{enumerable:!0,writable:!0,configurable:!0,value:null})})),this.cached_value_=t,window.localStorage.setItem(this.storage_name,JSON.stringify(this.cached_value_))}get value(){return Object.keys(this.cached_value_)}add(e){Object.defineProperty(this.cached_value_,e.toString(),{enumerable:!0,writable:!0,configurable:!0,value:null}),this.value=this.value}remove(e){delete this.cached_value_.item,this.value=this.value}}class ae extends se{constructor(){super(),this.cached_value_||(this.cached_value_=[])}get storage_name(){return"ScheduleTable"}set value(e){this.cached_value_=e,window.localStorage.setItem(this.storage_name,JSON.stringify(this.cached_value_))}get value(){return this.cached_value_}add(e){this.cached_value_=this.cached_value_.concat(e),this.value=this.value}remove(e){for(var t=0;t<this.cached_value_.length;t++)if(this.cached_value_[t]===e){1==this.cached_value_.length?this.cached_value_=[]:this.cached_value_=this.cached_value_.slice(0,t).concat(this.cached_value_.slice(t+1));break}this.value=this.value}}const le=(()=>{const e={tmpl:document.getElementById("appTemplate").content},t={content:e.tmpl.querySelector("kor-page"),notification:e.tmpl.getElementById("pageNotification"),top_bar:e.tmpl.querySelector("kor-app-bar"),menu:{button:e.tmpl.getElementById("appMenu"),tooltip:e.tmpl.getElementById("appMenuTooltip"),popover:{content:e.tmpl.getElementById("appMenuPopover"),login:e.tmpl.getElementById("loginMenuItem"),prefs:e.tmpl.getElementById("prefsMenuItem")}},add_transaction:e.tmpl.getElementById("addTransaction"),add_transaction_tooltip:e.tmpl.getElementById("addTransactionTooltip"),summary:{content:e.tmpl.getElementById("summaryContent"),details:e.tmpl.getElementById("summaryDetails")},transactions:{content:e.tmpl.getElementById("transactionsContent"),details:e.tmpl.getElementById("transactionsDetails"),filter_button:e.tmpl.getElementById("transactionsFilterButton")},schedule:{content:e.tmpl.getElementById("scheduleContent"),details:e.tmpl.getElementById("scheduleDetails"),add_button:e.tmpl.getElementById("scheduleAddButton")},tab_strip:e.tmpl.querySelector("kor-tabs")},o={window:e.tmpl.getElementById("addTransactionModal"),notification:e.tmpl.getElementById("addTransactionModalNotification"),content:e.tmpl.getElementById("addTransactionModalContent"),button:e.tmpl.getElementById("addTransactionModalButton")},n=e.tmpl.getElementById("transactionDetailsModal"),r={window:e.tmpl.getElementById("addScheduleModal"),notification:e.tmpl.getElementById("addScheduleModalNotification"),transactions_content:e.tmpl.getElementById("addScheduleModalTransactionContent"),schedule_content:e.tmpl.getElementById("addScheduleModalScheduleContent"),button:e.tmpl.getElementById("addScheduleModalButton")};if(O(te.tab_strip(t.summary,t.transactions,t.schedule),t.tab_strip),t.content&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches){t.content.setAttribute("theme","dark"),o.window.setAttribute("theme","dark"),n.setAttribute("theme","dark"),r.window.setAttribute("theme","dark");const e=document.createElement("style");e.innerHTML='\n      input[type="date"] {\n        background: transparent;\n        color: white;\n      }\n      input[type="date"]::-webkit-calendar-picker-indicator {\n        filter: invert(100%);\n      }',document.body.appendChild(e)}t.menu.button.addEventListener("click",(()=>{t.menu.tooltip.setAttribute("visible","false")}));let i={};t.menu.popover.login.setAttribute("login","true");const s=ie.Init(t.summary.details,t.transactions.details,t.schedule.details,t.menu.popover.login,t.add_transaction,n,i);t.menu.popover.login.addEventListener("click",(()=>{t.menu.popover.content.removeAttribute("visible"),s()}));let c={gas_price:1,gas_limit:21e3},a=new ce;t.add_transaction.addEventListener("click",(()=>{t.add_transaction_tooltip.setAttribute("visible","false"),O(oe.add_transaction(6,[],a,c),o.content),o.window.setAttribute("visible","true")})),o.window.addEventListener("visible-changed",(e=>{if(!e.target.visible){const e=o.notification.querySelector("kor-notification-item");e&&e.removeAttribute("visible")}})),o.button.addEventListener("click",(()=>{if(ne.check_transaction_data(c,o.notification)&&(o.window.removeAttribute("visible"),console.log("The transaction's destination_address == ",c.destination_address),console.log("The transaction's amount == ",c.amount),c.destination_address&&c.amount>0)){const e={from:Moralis.User.current().get("ethAddress"),to:c.destination_address,value:c.amount*Math.pow(10,18),gasPrice:c.gas_price*Math.pow(10,9),gas:c.gas_limit};console.log("The transactionObject == ",e),i.web3.eth.sendTransaction(e,((e,o)=>{if(console.log("The sendTransaction error == ",e),console.log("The sendTransaction result == ",o),!e){a.add(c.destination_address),O(te.success_notifications(["The transaction was sent and will be shown in the Transactions tab after processing"]),t.notification);t.notification.querySelector("kor-notification-item").setAttribute("visible","true")}let n={};Object.assign(n,c),c=n}))}}));let l={},d=new ae;const h=()=>{O(re.schedule_table(d,h),t.schedule.details)};return h(),t.schedule.add_button.addEventListener("click",(()=>{O(oe.add_transaction(6,[],a,c),r.transactions_content),O(re.add_schedule(l),r.schedule_content),r.window.setAttribute("visible","true")})),r.window.addEventListener("visible-changed",(e=>{if(!e.target.visible){const e=r.notification.querySelector("kor-notification-item");e&&e.removeAttribute("visible")}})),r.button.addEventListener("click",(()=>{if(!ne.check_transaction_data(c,r.notification))return;if(!ne.check_schedule_data(l,r.notification))return;const e={transaction_data:c,schedule_data:l};d.add(e),r.window.removeAttribute("visible"),O(re.schedule_table(d,h),t.schedule.details);let o={};Object.assign(o,c),c=o,o={},Object.assign(o,l),l=o})),e})();document.addEventListener("DOMContentLoaded",(()=>{Moralis.initialize("pnj2ou0ivNkr2xnWIQIKZjwhcbJgC6hO69CasCTS"),Moralis.serverURL="https://kcmeib0ovv6c.moralis.io:2053/server";const e=document.getElementsByTagName("body")[0];e.removeChild(document.getElementById("startupContent")),e.appendChild(le.tmpl)}));
