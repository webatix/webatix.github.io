...
`},function(t,e,o){var i,r,n,s;o.d(e,"a",(function(){return _})),o.d(e,"b",(function(){return E})),o.d(e,"c",(function(){return O})),o.d(e,"d",(function(){return S}));const a=globalThis.trustedTypes,l=a?a.createPolicy("lit-html",{createHTML:t=>t}):void 0,c=`lit$${(Math.random()+"").slice(9)}$`,d="?"+c,h=`<${d}>`,p=document,u=(t="")=>p.createComment(t),b=t=>null===t||"object"!=typeof t&&"function"!=typeof t,f=Array.isArray,g=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,v=/-->/g,m=/>/g,y=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,k=/'/g,w=/"/g,x=/^(?:script|style|textarea)$/i,_=(t=>(e,...o)=>({_$litType$:t,strings:e,values:o}))(1),E=Symbol.for("lit-noChange"),O=Symbol.for("lit-nothing"),j=new WeakMap,S=(t,e,o)=>{var i,r;const n=null!==(i=null==o?void 0:o.renderBefore)&&void 0!==i?i:e;let s=n._$litPart$;if(void 0===s){const t=null!==(r=null==o?void 0:o.renderBefore)&&void 0!==r?r:null;n._$litPart$=s=new T(e.insertBefore(u(),t),t,void 0,o)}return s.I(t),s},$=p.createTreeWalker(p,129,null,!1),C=(t,e)=>{const o=t.length-1,i=[];let r,n=2===e?"<svg>":"",s=g;for(let e=0;e<o;e++){const o=t[e];let a,l,d=-1,p=0;for(;p<o.length&&(s.lastIndex=p,l=s.exec(o),null!==l);)p=s.lastIndex,s===g?"!--"===l[1]?s=v:void 0!==l[1]?s=m:void 0!==l[2]?(x.test(l[2])&&(r=RegExp("</"+l[2],"g")),s=y):void 0!==l[3]&&(s=y):s===y?">"===l[0]?(s=null!=r?r:g,d=-1):void 0===l[1]?d=-2:(d=s.lastIndex-l[2].length,a=l[1],s=void 0===l[3]?y:'"'===l[3]?w:k):s===w||s===k?s=y:s===v||s===m?s=g:(s=y,r=void 0);const u=s===y&&t[e+1].startsWith("/>")?" ":"";n+=s===g?o+h:d>=0?(i.push(a),o.slice(0,d)+"$lit$"+o.slice(d)+c+u):o+c+(-2===d?(i.push(void 0),e):u)}const a=n+(t[o]||"<?>")+(2===e?"</svg>":"");return[void 0!==l?l.createHTML(a):a,i]};class P{constructor({strings:t,_$litType$:e},o){let i;this.parts=[];let r=0,n=0;const s=t.length-1,l=this.parts,[h,p]=C(t,e);if(this.el=P.createElement(h,o),$.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(i=$.nextNode())&&l.length<s;){if(1===i.nodeType){if(i.hasAttributes()){const t=[];for(const e of i.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(c)){const o=p[n++];if(t.push(e),void 0!==o){const t=i.getAttribute(o.toLowerCase()+"$lit$").split(c),e=/([.?@])?(.*)/.exec(o);l.push({type:1,index:r,name:e[2],strings:t,ctor:"."===e[1]?I:"?"===e[1]?B:"@"===e[1]?M:z})}else l.push({type:6,index:r})}for(const e of t)i.removeAttribute(e)}if(x.test(i.tagName)){const t=i.textContent.split(c),e=t.length-1;if(e>0){i.textContent=a?a.emptyScript:"";for(let o=0;o<e;o++)i.append(t[o],u()),$.nextNode(),l.push({type:2,index:++r});i.append(t[e],u())}}}else if(8===i.nodeType)if(i.data===d)l.push({type:2,index:r});else{let t=-1;for(;-1!==(t=i.data.indexOf(c,t+1));)l.push({type:7,index:r}),t+=c.length-1}r++}}static createElement(t,e){const o=p.createElement("template");return o.innerHTML=t,o}}function A(t,e,o=t,i){var r,n,s,a;if(e===E)return e;let l=void 0!==i?null===(r=o.Σi)||void 0===r?void 0:r[i]:o.Σo;const c=b(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(n=null==l?void 0:l.O)||void 0===n||n.call(l,!1),void 0===c?l=void 0:(l=new c(t),l.T(t,o,i)),void 0!==i?(null!==(s=(a=o).Σi)&&void 0!==s?s:a.Σi=[])[i]=l:o.Σo=l),void 0!==l&&(e=A(t,l.S(t,e.values),l,i)),e}class R{constructor(t,e){this.l=[],this.N=void 0,this.D=t,this.M=e}u(t){var e;const{el:{content:o},parts:i}=this.D,r=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:p).importNode(o,!0);$.currentNode=r;let n=$.nextNode(),s=0,a=0,l=i[0];for(;void 0!==l;){if(s===l.index){let e;2===l.type?e=new T(n,n.nextSibling,this,t):1===l.type?e=new l.ctor(n,l.name,l.strings,this,t):6===l.type&&(e=new N(n,this,t)),this.l.push(e),l=i[++a]}s!==(null==l?void 0:l.index)&&(n=$.nextNode(),s++)}return r}v(t){let e=0;for(const o of this.l)void 0!==o&&(void 0!==o.strings?(o.I(t,o,e),e+=o.strings.length-2):o.I(t[e])),e++}}class T{constructor(t,e,o,i){this.type=2,this.N=void 0,this.A=t,this.B=e,this.M=o,this.options=i}setConnected(t){var e;null===(e=this.P)||void 0===e||e.call(this,t)}get parentNode(){return this.A.parentNode}get startNode(){return this.A}get endNode(){return this.B}I(t,e=this){t=A(this,t,e),b(t)?t===O||null==t||""===t?(this.H!==O&&this.R(),this.H=O):t!==this.H&&t!==E&&this.m(t):void 0!==t._$litType$?this._(t):void 0!==t.nodeType?this.$(t):(t=>{var e;return f(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.g(t):this.m(t)}k(t,e=this.B){return this.A.parentNode.insertBefore(t,e)}$(t){this.H!==t&&(this.R(),this.H=this.k(t))}m(t){const e=this.A.nextSibling;null!==e&&3===e.nodeType&&(null===this.B?null===e.nextSibling:e===this.B.previousSibling)?e.data=t:this.$(p.createTextNode(t)),this.H=t}_(t){var e;const{values:o,_$litType$:i}=t,r="number"==typeof i?this.C(t):(void 0===i.el&&(i.el=P.createElement(i.h,this.options)),i);if((null===(e=this.H)||void 0===e?void 0:e.D)===r)this.H.v(o);else{const t=new R(r,this),e=t.u(this.options);t.v(o),this.$(e),this.H=t}}C(t){let e=j.get(t.strings);return void 0===e&&j.set(t.strings,e=new P(t)),e}g(t){f(this.H)||(this.H=[],this.R());const e=this.H;let o,i=0;for(const r of t)i===e.length?e.push(o=new T(this.k(u()),this.k(u()),this,this.options)):o=e[i],o.I(r),i++;i<e.length&&(this.R(o&&o.B.nextSibling,i),e.length=i)}R(t=this.A.nextSibling,e){var o;for(null===(o=this.P)||void 0===o||o.call(this,!1,!0,e);t&&t!==this.B;){const e=t.nextSibling;t.remove(),t=e}}}class z{constructor(t,e,o,i,r){this.type=1,this.H=O,this.N=void 0,this.V=void 0,this.element=t,this.name=e,this.M=i,this.options=r,o.length>2||""!==o[0]||""!==o[1]?(this.H=Array(o.length-1).fill(O),this.strings=o):this.H=O}get tagName(){return this.element.tagName}I(t,e=this,o,i){const r=this.strings;let n=!1;if(void 0===r)t=A(this,t,e,0),n=!b(t)||t!==this.H&&t!==E,n&&(this.H=t);else{const i=t;let s,a;for(t=r[0],s=0;s<r.length-1;s++)a=A(this,i[o+s],e,s),a===E&&(a=this.H[s]),n||(n=!b(a)||a!==this.H[s]),a===O?t=O:t!==O&&(t+=(null!=a?a:"")+r[s+1]),this.H[s]=a}n&&!i&&this.W(t)}W(t){t===O?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class I extends z{constructor(){super(...arguments),this.type=3}W(t){this.element[this.name]=t===O?void 0:t}}class B extends z{constructor(){super(...arguments),this.type=4}W(t){t&&t!==O?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}}class M extends z{constructor(){super(...arguments),this.type=5}I(t,e=this){var o;if((t=null!==(o=A(this,t,e,0))&&void 0!==o?o:O)===E)return;const i=this.H,r=t===O&&i!==O||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==O&&(i===O||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this.H=t}handleEvent(t){var e,o;"function"==typeof this.H?this.H.call(null!==(o=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==o?o:this.element,t):this.H.handleEvent(t)}}class N{constructor(t,e,o){this.element=t,this.type=6,this.N=void 0,this.V=void 0,this.M=e,this.options=o}I(t){A(this,t)}}null===(r=(i=globalThis).litHtmlPlatformSupport)||void 0===r||r.call(i,P,T),(null!==(n=(s=globalThis).litHtmlVersions)&&void 0!==n?n:s.litHtmlVersions=[]).push("2.0.0-rc.3")},function(t,e,o){o.d(e,"a",(function(){return a}));var i=o(0),r=o(1),n=o(2),s=function(t,e,o,i){var r,n=arguments.length,s=n<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,o,i);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(s=(n<3?r(s):n>3?r(e,o,s):r(e,o))||s);return n>3&&s&&Object.defineProperty(e,o,s),s};class a extends i.a{constructor(){super(...arguments),this.size="m"}static get styles(){return[n.a,i.b`
        :host {
    ...
    `}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.dispatchEvent(new Event(t+"-changed")),"grid-cols"==t&&(this.style.gridColumn="span "+this.gridCols),"sortable"==t&&this.sortable&&(this.sortDirection||(this.sortDirection="asc"),this.addEventListener("click",(()=>{this.handleSort()})))}handleSort(){var t;if(this.sorted)this.sortDirection="asc"==this.sortDirection?"desc":"asc";else{let e=null===(t=this.parentElement)||void 0===t?void 0:t.childNodes;null==e||e.forEach((t=>{t.sorted=!1})),this.sorted=!0,this.sortDirection="asc"}}}s([Object(r.a)({type:Number,reflect:!0,attribute:"grid-cols"})],a.prototype,"gridCols",void 0),s([Object(r.a)({type:String,reflect:!0})],a.prototype,"alignment",void 0),s([Object(r.a)({type:Boolean,reflect:!0})],a.prototype,"head",void 0),s([Object(r.a)({type:Boolean,reflect:!0})],a.prototype,"sorted",void 0),s([Object(r.a)({type:Boolean,reflect:!0})],a.prototype,"sortable",void 0),s([Object(r.a)({type:String,reflect:!0,attribute:"sort-direction"})],a.prototype,"sortDirection",void 0),window.customElements.get("kor-table-cell")||window.customElements.define("kor-table-cell",a)},,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,function(t,e,o){o.r(e),o.d(e,"korAccordion",(function(){return i.a})),o.d(e,"korAppBar",(function(){return r.a})),o.d(e,"korAvatar",(function(){return n.a})),o.d(e,"korBadge",(function(){return s.a})),o.d(e,"korBreadcrumbs",(function(){return a.a})),o.d(e,"korBreadcrumbItem",(function(){return l.a})),o.d(e,"korButton",(function(){return c.a})),o.d(e,"korCard",(function(){return d.a})),o.d(e,"korCheckbox",(function(){return h.a})),o.d(e,"korDivider",(function(){return p.a})),o.d(e,"korDrawer",(function(){return u.a})),o.d(e,"korEmptyState",(function(){return b.a})),o.d(e,"korGrid",(function(){return f.a})),o.d(e,"korImage",(function(){return g.a})),o.d(e,"korIcon",(function(){return v.a})),o.d(e,"korInput",(function(){return m.a})),o.d(e,"korMenuItem",(function(){return y.a})),o.d(e,"korModal",(function(){return k.a})),o.d(e,"korNavbar",(function(){return w.a})),o.d(e,"korNotifications",(function(){return x.a})),o.d(e,"korNotificationItem",(function(){return _.a})),o.d(e,"korPage",(function(){return E.a})),o.d(e,"korPane",(function(){return O.a})),o.d(e,"korPopover",(function(){return j.a})),o.d(e,"korProgressBar",(function(){return S.a})),o.d(e,"korRadioButton",(function(){return $.a})),o.d(e,"korSlider",(function(){return C.a})),o.d(e,"korSpinner",(function(){return P.a})),o.d(e,"korStepper",(function(){return A.a})),o.d(e,"korStepperItem",(function(){return R.a})),o.d(e,"korSwipeActions",(function(){return I})),o.d(e,"korSwipeAction",(function(){return N})),o.d(e,"korSwitch",(function(){return D.a})),o.d(e,"korSwitchItem",(function(){return L.a})),o.d(e,"korTabItem",(function(){return H.a})),o.d(e,"korTable",(function(){return U.a})),o.d(e,"korTableRow",(function(){return F.a})),o.d(e,"korTableCell",(function(){return q.a})),o.d(e,"korTabs",(function(){return W.a})),o.d(e,"korTag",(function(){return V.a})),o.d(e,"korText",(function(){return J.a})),o.d(e,"korTextarea",(function(){return G.a})),o.d(e,"korToggle",(function(){return K.a})),o.d(e,"korTool",(function(){return Z.a})),o.d(e,"korTooltip",(function(){return X.a}));var i=o(12),r=o(10),n=o(13),s=o(14),a=o(15),l=o(16),c=o(17),d=o(8),h=o(18),p=o(19),u=o(20),b=o(21),f=o(22),g=o(23),v=o(4),m=o(49),y=o(24),k=o(25),w=o(26),x=o(28),_=o(29),E=o(30),O=o(31),j=o(11),S=o(32),$=o(33),C=o(34),P=o(35),A=o(36),R=o(37),T=o(0),z=o(2);class I extends T.a{static get styles(){return[z.a,T.b`
      ...
      <slot 
        ...
        @slotchange="${t=>this.setSlotWidth(t.target)}"
      ></slot>
    `}connectedCallback(){super.connectedCallback(),this.addEventListener("touchend",this.handleTouchEnd),this.addEventListener("scroll",this.setSlotOpacity)}setSlotWidth(t){t.assignedNodes().length>0?t.style.minWidth="100%":t.style.minWidth="unset"}handleTouchEnd(){const t=this.scrollLeft-this.clientWidth;t<this.clientWidth/3*-1?this.dispatchEvent(new Event("swipe-left")):t>this.clientWidth/3&&this.dispatchEvent(new Event("swipe-right"))}setSlotOpacity(){var t,e;const o=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector('slot[name="left"]'),i=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector('slot[name="right"]'),r=this.scrollLeft-this.clientWidth;o&&(o.style.opacity=-1*r/this.clientWidth*3>1?1:.5),i&&(i.style.opacity=1*r/this.clientWidth*3>1?1:.5)}getSlotOpacity(t){const e="left"===t?-1:1,o=(this.scrollLeft-this.clientWidth)*e/this.clientWidth*3;return o>1?1:o<0?0:o}}window.customElements.get("kor-swipe-actions")||window.customElements.define("kor-swipe-actions",I);var B=o(1),M=function(t,e,o,i){var r,n=arguments.length,s=n<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,o,i);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(s=(n<3?r(s):n>3?r(e,o,s):r(e,o))||s);return n>3&&s&&Object.defineProperty(e,o,s),s};class N extends T.a{static get styles(){return[z.a,T.b`
        :host {
          height: 100%;
          width: 100%;
          position: relative;
    ...
    `}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.dispatchEvent(new Event(t+"-changed")),"bg-color"===t&&o!==e&&(this.style.backgroundColor=o)}connectedCallback(){super.connectedCallback()}}M([Object(B.a)({reflect:!0})],N.prototype,"icon",void 0),M([Object(B.a)({reflect:!0,attribute:"bg-color"})],N.prototype,"bgColor",void 0),window.customElements.get("kor-swipe-action")||window.customElements.define("kor-swipe-action",N);var D=o(38),L=o(39),H=o(40),U=o(41),F=o(50),q=o(51),W=o(42),V=o(43),J=o(6),G=o(44),K=o(45),Z=o(46),X=o(47)}]);const r=globalThis.trustedTypes,n=r?r.createPolicy("lit-html",{createHTML:t=>t}):void 0,s=`lit$${(Math.random()+"").slice(9)}$`,a="?"+s,l=`<${a}>`,c=document,d=(t="")=>c.createComment(t),h=t=>null===t||"object"!=typeof t&&"function"!=typeof t,p=Array.isArray,u=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,b=/-->/g,f=/>/g,g=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,v=/'/g,m=/"/g,y=/^(?:script|style|textarea)$/i,k=(t=>(e,...o)=>({_$litType$:t,strings:e,values:o}))(1),w=Symbol.for("lit-noChange"),x=Symbol.for("lit-nothing"),_=new WeakMap,E=(t,e,o)=>{var i,r;const n=null!==(i=null==o?void 0:o.renderBefore)&&void 0!==i?i:e;let s=n._$litPart$;if(void 0===s){const t=null!==(r=null==o?void 0:o.renderBefore)&&void 0!==r?r:null;n._$litPart$=s=new C(e.insertBefore(d(),t),t,void 0,o)}return s.I(t),s},O=c.createTreeWalker(c,129,null,!1);class j{constructor({strings:t,_$litType$:e},o){let i;this.parts=[];let c=0,h=0;const p=t.length-1,k=this.parts,[w,x]=((t,e)=>{const o=t.length-1,i=[];let r,a=2===e?"<svg>":"",c=u;for(let e=0;e<o;e++){const o=t[e];let n,d,h=-1,p=0;for(;p<o.length&&(c.lastIndex=p,d=c.exec(o),null!==d);)p=c.lastIndex,c===u?"!--"===d[1]?c=b:void 0!==d[1]?c=f:void 0!==d[2]?(y.test(d[2])&&(r=RegExp("</"+d[2],"g")),c=g):void 0!==d[3]&&(c=g):c===g?">"===d[0]?(c=null!=r?r:u,h=-1):void 0===d[1]?h=-2:(h=c.lastIndex-d[2].length,n=d[1],c=void 0===d[3]?g:'"'===d[3]?m:v):c===m||c===v?c=g:c===b||c===f?c=u:(c=g,r=void 0);const k=c===g&&t[e+1].startsWith("/>")?" ":"";a+=c===u?o+l:h>=0?(i.push(n),o.slice(0,h)+"$lit$"+o.slice(h)+s+k):o+s+(-2===h?(i.push(void 0),e):k)}const d=a+(t[o]||"<?>")+(2===e?"</svg>":"");return[void 0!==n?n.createHTML(d):d,i]})(t,e);if(this.el=j.createElement(w,o),O.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(i=O.nextNode())&&k.length<p;){if(1===i.nodeType){if(i.hasAttributes()){const t=[];for(const e of i.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(s)){const o=x[h++];if(t.push(e),void 0!==o){const t=i.getAttribute(o.toLowerCase()+"$lit$").split(s),e=/([.?@])?(.*)/.exec(o);k.push({type:1,index:c,name:e[2],strings:t,ctor:"."===e[1]?A:"?"===e[1]?R:"@"===e[1]?T:P})}else k.push({type:6,index:c})}for(const e of t)i.removeAttribute(e)}if(y.test(i.tagName)){const t=i.textContent.split(s),e=t.length-1;if(e>0){i.textContent=r?r.emptyScript:"";for(let o=0;o<e;o++)i.append(t[o],d()),O.nextNode(),k.push({type:2,index:++c});i.append(t[e],d())}}}else if(8===i.nodeType)if(i.data===a)k.push({type:2,index:c});else{let t=-1;for(;-1!==(t=i.data.indexOf(s,t+1));)k.push({type:7,index:c}),t+=s.length-1}c++}}static createElement(t,e){const o=c.createElement("template");return o.innerHTML=t,o}}function S(t,e,o=t,i){var r,n,s,a;if(e===w)return e;let l=void 0!==i?null===(r=o.Σi)||void 0===r?void 0:r[i]:o.Σo;const c=h(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(n=null==l?void 0:l.O)||void 0===n||n.call(l,!1),void 0===c?l=void 0:(l=new c(t),l.T(t,o,i)),void 0!==i?(null!==(s=(a=o).Σi)&&void 0!==s?s:a.Σi=[])[i]=l:o.Σo=l),void 0!==l&&(e=S(t,l.S(t,e.values),l,i)),e}class ${constructor(t,e){this.l=[],this.N=void 0,this.D=t,this.M=e}u(t){var e;const{el:{content:o},parts:i}=this.D,r=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:c).importNode(o,!0);O.currentNode=r;let n=O.nextNode(),s=0,a=0,l=i[0];for(;void 0!==l;){if(s===l.index){let e;2===l.type?e=new C(n,n.nextSibling,this,t):1===l.type?e=new l.ctor(n,l.name,l.strings,this,t):6===l.type&&(e=new z(n,this,t)),this.l.push(e),l=i[++a]}s!==(null==l?void 0:l.index)&&(n=O.nextNode(),s++)}return r}v(t){let e=0;for(const o of this.l)void 0!==o&&(void 0!==o.strings?(o.I(t,o,e),e+=o.strings.length-2):o.I(t[e])),e++}}class C{constructor(t,e,o,i){this.type=2,this.N=void 0,this.A=t,this.B=e,this.M=o,this.options=i}setConnected(t){var e;null===(e=this.P)||void 0===e||e.call(this,t)}get parentNode(){return this.A.parentNode}get startNode(){return this.A}get endNode(){return this.B}I(t,e=this){t=S(this,t,e),h(t)?t===x||null==t||""===t?(this.H!==x&&this.R(),this.H=x):t!==this.H&&t!==w&&this.m(t):void 0!==t._$litType$?this._(t):void 0!==t.nodeType?this.$(t):(t=>{var e;return p(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.g(t):this.m(t)}k(t,e=this.B){return this.A.parentNode.insertBefore(t,e)}$(t){this.H!==t&&(this.R(),this.H=this.k(t))}m(t){const e=this.A.nextSibling;null!==e&&3===e.nodeType&&(null===this.B?null===e.nextSibling:e===this.B.previousSibling)?e.data=t:this.$(c.createTextNode(t)),this.H=t}_(t){var e;const{values:o,_$litType$:i}=t,r="number"==typeof i?this.C(t):(void 0===i.el&&(i.el=j.createElement(i.h,this.options)),i);if((null===(e=this.H)||void 0===e?void 0:e.D)===r)this.H.v(o);else{const t=new $(r,this),e=t.u(this.options);t.v(o),this.$(e),this.H=t}}C(t){let e=_.get(t.strings);return void 0===e&&_.set(t.strings,e=new j(t)),e}g(t){p(this.H)||(this.H=[],this.R());const e=this.H;let o,i=0;for(const r of t)i===e.length?e.push(o=new C(this.k(d()),this.k(d()),this,this.options)):o=e[i],o.I(r),i++;i<e.length&&(this.R(o&&o.B.nextSibling,i),e.length=i)}R(t=this.A.nextSibling,e){var o;for(null===(o=this.P)||void 0===o||o.call(this,!1,!0,e);t&&t!==this.B;){const e=t.nextSibling;t.remove(),t=e}}}class P{constructor(t,e,o,i,r){this.type=1,this.H=x,this.N=void 0,this.V=void 0,this.element=t,this.name=e,this.M=i,this.options=r,o.length>2||""!==o[0]||""!==o[1]?(this.H=Array(o.length-1).fill(x),this.strings=o):this.H=x}get tagName(){return this.element.tagName}I(t,e=this,o,i){const r=this.strings;let n=!1;if(void 0===r)t=S(this,t,e,0),n=!h(t)||t!==this.H&&t!==w,n&&(this.H=t);else{const i=t;let s,a;for(t=r[0],s=0;s<r.length-1;s++)a=S(this,i[o+s],e,s),a===w&&(a=this.H[s]),n||(n=!h(a)||a!==this.H[s]),a===x?t=x:t!==x&&(t+=(null!=a?a:"")+r[s+1]),this.H[s]=a}n&&!i&&this.W(t)}W(t){t===x?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class A extends P{constructor(){super(...arguments),this.type=3}W(t){this.element[this.name]=t===x?void 0:t}}class R extends P{constructor(){super(...arguments),this.type=4}W(t){t&&t!==x?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name)}}class T extends P{constructor(){super(...arguments),this.type=5}I(t,e=this){var o;if((t=null!==(o=S(this,t,e,0))&&void 0!==o?o:x)===w)return;const i=this.H,r=t===x&&i!==x||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==x&&(i===x||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this.H=t}handleEvent(t){var e,o;"function"==typeof this.H?this.H.call(null!==(o=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==o?o:this.element,t):this.H.handleEvent(t)}}class z{constructor(t,e,o){this.element=t,this.type=6,this.N=void 0,this.V=void 0,this.M=e,this.options=o}I(t){S(this,t)}}null===(e=(t=globalThis).litHtmlPlatformSupport)||void 0===e||e.call(t,j,C),(null!==(o=(i=globalThis).litHtmlVersions)&&void 0!==o?o:i.litHtmlVersions=[]).push("2.0.0-rc.2");
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const I=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,B=Symbol();class M{constructor(t,e){if(e!==B)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return I&&void 0===this.t&&(this.t=new CSSStyleSheet,this.t.replaceSync(this.cssText)),this.t}toString(){return this.cssText}}const N=new Map,D=(t,...e)=>{const o=e.reduce(((e,o,i)=>e+(t=>{if(t instanceof M)return t.cssText;if("number"==typeof t)return t;throw Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(o)+t[i+1]),t[0]);let i=N.get(o);return void 0===i&&N.set(o,i=new M(o,B)),i},L=(t,e)=>{I?t.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((e=>{const o=document.createElement("style");o.textContent=e.cssText,t.appendChild(o)}))},H=I?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const o of t.cssRules)e+=o.cssText;return(t=>new M(t+"",B))(e)})(t):t
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var Z,X,Q,Y,tt,et;K.finalized=!0,K.shadowRootOptions={mode:"open"},null===(F=(U=globalThis).reactiveElementPlatformSupport)||void 0===F||F.call(U,{ReactiveElement:K}),(null!==(q=(W=globalThis).reactiveElementVersions)&&void 0!==q?q:W.reactiveElementVersions=[]).push("1.0.0-rc.1"),(null!==(Z=(et=globalThis).litElementVersions)&&void 0!==Z?Z:et.litElementVersions=[]).push("3.0.0-rc.1");class ot extends K{constructor(){super(...arguments),this.renderOptions={host:this},this.Φt=void 0}createRenderRoot(){var t,e;const o=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=o.firstChild),o}update(t){const e=this.render();super.update(t),this.Φt=E(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this.Φt)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this.Φt)||void 0===t||t.setConnected(!1)}render(){return w}}ot.finalized=!0,ot._$litElement$=!0,null===(Q=(X=globalThis).litElementHydrateSupport)||void 0===Q||Q.call(X,{LitElement:ot}),null===(tt=(Y=globalThis).litElementPlatformSupport)||void 0===tt||tt.call(Y,{LitElement:ot});var it={tab_strip:(t,e,o)=>k`
      ...
      </kor-tab-item>`,object_entries_two_columns:t=>k`
      ...
      </kor-table>`,error_notifications:t=>k`
      ...
      </kor-notifications>`,success_notifications:t=>k`
      <kor-notifications position="top-right">
        <kor-notification-item icon="done" label="Success">
        ${t.map((t=>k`
            <kor-text size="body-1">${JSON.stringify(t)}</kor-text>`))}
        </kor-notification-item>
      </kor-notifications>`},rt={transactions:(t,e,o)=>k`
      <kor-grid columns="2">
      ...
      </kor-grid>`,add_transaction:(t,e,o,i)=>k`
 ...
 */,Ot=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(o){o.createProperty(e.key,t)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(o){o.createProperty(e.key,t)}};function jt(t){return(e,o)=>void 0!==o?((t,e,o)=>{e.constructor.createProperty(o,t)})(t,e,o):Ot(t,e)}vt([Et("dapp-deploy-contract")],(function(t,e){class o extends e{constructor(){super(),t(this),nt.get_current_address().then((t=>{this.owner_address||(this.owner_address=t)}))}}return{F:o,d:[{kind:"field",decorators:[jt({type:Boolean,reflect:!0})],key:"visible",value:()=>!1},{kind:"field",decorators:[jt({type:String,reflect:!0})],key:"theme",value:()=>"light"},{kind:"field",decorators:[jt({type:String,reflect:!0})],key:"owner_address",value:()=>null},{kind:"field",decorators:[jt({type:Object,reflect:!1,noAccessor:!0})],key:"notification_container",value:()=>document.createElement("div")},{kind:"field",decorators:[jt({type:Object,reflect:!1,noAccessor:!0})],key:"contract_instance",value:()=>null},{kind:"field",decorators:[jt({type:Object,reflect:!1,noAccessor:!0,state:!0})],key:"contract_json_interface_",value:()=>null},{kind:"field",decorators:[jt({type:Number,reflect:!1,noAccessor:!0,state:!0})],key:"gas_price_gwei_",value:()=>1},{kind:"field",decorators:[jt({type:Array,reflect:!1,noAccessor:!0,state:!0})],key:"errors_",value:()=>[]},{kind:"field",decorators:[jt({type:Array,reflect:!1,noAccessor:!0,state:!0})],key:"successes_",value:()=>[]},{kind:"get",static:!0,key:"styles",value:function(){return D`
        ...
        <kor-card flat>
          <kor-grid columns="1" fit-content>
            <kor-card grid-cols="1" flat>
              ...
              ></kor-input>
              <input type="file"
                @change="${t=>{const e=t.target,o=new FileReader;if(o.onloadend=()=>{if(o.result||(this.errors_=this.errors_.concat("A file reading error")),window.ethereum||(this.errors_=this.errors_.concat("A blockchain provider hasn't found in the window.ethereum, install Metamask please")),this.errors_.length)return void nt.error_notifications(this.errors_,this.notification_container);const t={language:"Solidity",sources:{[this.contract_filename_]:{content:o.result}},settings:{outputSelection:{"*":{"*":["*"]}}}};console.log("The solc input == ",t),this.solc_worker_.postMessage(JSON.stringify(t))},!e.files[0]||!e.files[0].name)return this.errors_=this.errors_.concat("Please specify a file with a contract's code to compile"),void nt.error_notifications(this.errors_,this.notification_container);this.contract_filename_=e.files[0].name,this.contract_filename_short_=this.contract_filename_.replace(/\.[^.]+$/,""),o.readAsText(e.files[0])}}"
              >
            </kor-card>
          </kor-grid>
        </kor-card>
        <kor-button label="Estimate a gas usage" color="Primary" slot="footer" disabled="true"
          @click="${t=>{this.contract_instance.deploy({data:this.compiled_contract_.contracts[this.contract_filename_][this.contract_filename_short_].evm.bytecode.object}).estimateGas(((t,e)=>{t&&(this.errors_=this.errors_.concat(t),nt.error_notifications(this.errors_,this.notification_container)),e&&(this.successes_=this.successes_.concat("The contract deployment will use ["+e+"] gas"),nt.success_notifications(this.successes_,this.notification_container))}))}}"
        ></kor-button>
        <kor-button label="Deploy the contract" color="Primary" slot="footer" disabled="true"
          @click="${t=>{if(!this.owner_address||42!=this.owner_address.toString().length)return this.errors_=this.errors_.concat("Please, fill a correct address from which the contract will be deployed"),void nt.error_notifications(this.errors_,this.notification_container);nt.send_transaction(this.contract_instance.deploy({data:this.compiled_contract_.contracts[this.contract_filename_][this.contract_filename_short_].evm.bytecode.object}),this.owner_address,this.gas_price_gwei_,0,this.errors_,this.successes_,this.notification_container).then((t=>{this.successes_=this.successes_.concat("The contract was deployed at address == "+t.options.address.toString()),nt.success_notifications(this.successes_,this.notification_container),this.contract_instance=t,this.dispatchEvent(new Event("contract-deployed",{bubbles:!0,composed:!0}))})),this.visible=!1}}"
        ></kor-button>
      </kor-modal>`}},{kind:"method",key:"handleCompiledContract",value:function(t){if(this.compiled_contract_=JSON.parse(t.data),console.log("The solc output == ",this.compiled_contract_),!(this.compiled_contract_.contracts&&this.compiled_contract_.contracts[this.contract_filename_]&&this.compiled_contract_.contracts[this.contract_filename_]&&this.compiled_contract_.contracts[this.contract_filename_][this.contract_filename_short_]))return this.errors_=this.errors_.concat(`The contract ${this.contract_filename_} can't be compiled`),this.compiled_contract_.errors&&(this.errors_=this.errors_.concat(this.compiled_contract_.errors[0].formattedMessage)),void nt.error_notifications(this.errors_,this.notification_container);const e=new Web3(window.ethereum);if(this.contract_instance=new e.eth.Contract(this.compiled_contract_.contracts[this.contract_filename_][this.contract_filename_short_].abi),!this.contract_instance)return this.errors_=this.errors_.concat("A contract instance creation error"),void nt.error_notifications(this.errors_,this.notification_container);const o=this.shadowRoot.querySelectorAll("kor-button");Array.from(o).map((t=>{t.removeAttribute("disabled")}))}},{kind:"method",key:"attributeChangedCallback",value:function(t,e,i){ut(pt(o.prototype),"attributeChangedCallback",this).call(this,t,e,i),this.shadowRoot&&("theme"==t&&this.shadowRoot.querySelector("input")&&("dark"==this.theme?this.shadowRoot.querySelector("input").classList.add("dark"):this.shadowRoot.querySelector("input").classList.remove("dark")),"visible"==t&&this.shadowRoot.querySelector("kor-modal")&&(1==this.visible?(this.errors_=[],this.successes_=[],this.shadowRoot.querySelector("kor-modal").setAttribute("visible",!0)):this.shadowRoot.querySelector("kor-modal").removeAttribute("visible"))),"owner_address"==t&&(this.successes_=this.successes_.concat("A contract will be deployed from that address == "+this.owner_address),nt.success_notifications(this.successes_,this.notification_container)),this.dispatchEvent(new Event(`${t}-changed`))}}]}}),ot),vt([Et("dapp-create-subscription-product")],(function(t,e){class o extends e{constructor(){super(),t(this),nt.get_current_address().then((t=>{this.vendor_address||(this.vendor_address=t)}))}}return{F:o,d:[{kind:"field",decorators:[jt({type:Boolean,reflect:!0})],key:"visible",value:()=>!1},{kind:"field",decorators:[jt({type:String,reflect:!0})],key:"theme",value:()=>"light"},{kind:"field",decorators:[jt({type:String,reflect:!0})],key:"vendor_address",value:()=>null},{kind:"field",decorators:[jt({type:Number,reflect:!0})],key:"productID",value:()=>null},{kind:"field",decorators:[jt({type:Object,reflect:!1,noAccessor:!0})],key:"notification_container",value:()=>document.createElement("div")},{kind:"field",decorators:[jt({type:Object,reflect:!1,noAccessor:!0})],key:"contract_instance",value:()=>null},{kind:"field",decorators:[jt({type:Object,reflect:!1,noAccessor:!0,state:!0})],key:"amount_gwei_",value:()=>1},{kind:"field",decorators:[jt({type:Object,reflect:!1,noAccessor:!0,state:!0})],key:"billing_interval_secs_",value:()=>1},{kind:"field",decorators:[jt({type:Number,reflect:!1,noAccessor:!0,state:!0})],key:"gas_price_gwei_",value:()=>1},{kind:"field",decorators:[jt({type:Array,reflect:!1,noAccessor:!0,state:!0})],key:"errors_",value:()=>[]},{kind:"field",decorators:[jt({type:Array,reflect:!1,noAccessor:!0,state:!0})],key:"successes_",value:()=>[]},{kind:"method",key:"render",value:function(){return k`
      ...
      >
          ...
          <kor-grid columns="1" fit-content>
            <kor-card grid-cols="1" flat>
              <kor-input label="The product ID" type="number" min=1 value="${this.productID}"
                @change="${t=>{this.productID=parseInt(t.target.value)}}"
              ></kor-input>
              <kor-input label="Value to add to the account balance in the smart contract in GWEI" type="number" min=0 value="${this.value_to_send_gwei_}"
                @change="${t=>{this.value_to_send_gwei_=parseInt(t.target.value)}}"
              ></kor-input>
        ...
        <kor-button label="Create" color="Primary" slot="footer"
          @click="${t=>{if(!this.contract_instance)return this.errors_=this.errors_.concat("Please set a contract instance into this component"),void nt.error_notifications(this.errors_,this.notification_container);const e=this.contract_instance.methods.subscribe(this.productID);console.log("The transaction_object == ",e),nt.send_transaction(e,this.vendor_address,this.gas_price_gwei_,this.value_to_send_gwei_,this.errors_,this.successes_,this.notification_container).then((t=>{this.successes_=this.successes_.concat(JSON.stringify(t)),nt.success_notifications(this.successes_,this.notification_container),console.log(t),this.dispatchEvent(new Event("subscription-created",{bubbles:!0,composed:!0}))})),this.visible=!1}}"
        ></kor-button>
      </kor-modal>`}},{kind:"method",key:"attributeChangedCallback",value:function(t,e,i){ut(pt(o.prototype),"attributeChangedCallback",this).call(this,t,e,i),this.shadowRoot&&"visible"==t&&this.shadowRoot.querySelector("kor-modal")&&(1==this.visible?(this.errors_=[],this.successes_=[],this.shadowRoot.querySelector("kor-modal").setAttribute("visible",!0)):this.shadowRoot.querySelector("kor-modal").removeAttribute("visible")),this.dispatchEvent(new Event(`${t}-changed`))}}]}}),ot);const St=(()=>{const t={tmpl:document.getElementById("appTemplate").content},e={content:t.tmpl.querySelector("kor-page"),notification:t.tmpl.getElementById("pageNotification"),top_bar:t.tmpl.querySelector("kor-app-bar"),menu:{button:t.tmpl.getElementById("appMenu"),tooltip:t.tmpl.getElementById("appMenuTooltip"),popover:{content:t.tmpl.getElementById("appMenuPopover"),login:t.tmpl.getElementById("loginMenuItem"),prefs:t.tmpl.getElementById("prefsMenuItem")}},add_transaction:t.tmpl.getElementById("addTransaction"),switch_chain:t.tmpl.getElementById("switchChain"),deposit_ethers:t.tmpl.getElementById("depositEthers"),deploy_contract:t.tmpl.getElementById("deployContract"),compile_deploy_contract:t.tmpl.getElementById("compileDeployContract"),create_subscription_product:t.tmpl.getElementById("createSubscriptionProduct"),subscribe:t.tmpl.getElementById("subscribe"),add_transaction_tooltip:t.tmpl.getElementById("addTransactionTooltip"),summary:{content:t.tmpl.getElementById("summaryContent"),details:t.tmpl.getElementById("summaryDetails")},transactions:{content:t.tmpl.getElementById("transactionsContent"),details:t.tmpl.getElementById("transactionsDetails"),filter_button:t.tmpl.getElementById("transactionsFilterButton")},schedule:{content:t.tmpl.getElementById("scheduleContent"),details:t.tmpl.getElementById("scheduleDetails"),add_button:t.tmpl.getElementById("scheduleAddButton")},tab_strip:t.tmpl.querySelector("kor-tabs")},o={window:t.tmpl.getElementById("addTransactionModal"),notification:t.tmpl.getElementById("addTransactionModalNotification"),content:t.tmpl.getElementById("addTransactionModalContent"),button:t.tmpl.getElementById("addTransactionModalButton")},i=t.tmpl.getElementById("transactionDetailsModal"),r={window:t.tmpl.getElementById("addScheduleModal"),notification:t.tmpl.getElementById("addScheduleModalNotification"),transactions_content:t.tmpl.getElementById("addScheduleModalTransactionContent"),schedule_content:t.tmpl.getElementById("addScheduleModalScheduleContent"),button:t.tmpl.getElementById("addScheduleModalButton")},n={window:t.tmpl.getElementById("depositEthersModal"),notification:t.tmpl.getElementById("depositEthersModalNotification"),value:t.tmpl.getElementById("depositEthersModalValue"),button:t.tmpl.getElementById("depositEthersModalButton")},s=t.tmpl.querySelector("dapp-deploy-contract");s.notification_container=e.notification;const a=t.tmpl.querySelector("dapp-compile-deploy-contract");a.notification_container=e.notification;const l=t.tmpl.querySelector("dapp-create-subscription-product");l.notification_container=e.notification;const c=t.tmpl.querySelector("dapp-subscribe");if(c.notification_container=e.notification,E(it.tab_strip(e.summary,e.transactions,e.schedule),e.tab_strip),e.content&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches){e.content.setAttribute("theme","dark"),o.window.setAttribute("theme","dark"),i.setAttribute("theme","dark"),r.window.setAttribute("theme","dark"),n.window.setAttribute("theme","dark");const t=document.createElement("style");t.innerHTML='\n      input[type="date"] {\n        background: transparent;\n        color: white;\n      }\n      input[type="date"]::-webkit-calendar-picker-indicator {\n        filter: invert(100%);\n      }',document.body.appendChild(t),s.setAttribute("theme","dark"),a.setAttribute("theme","dark"),l.setAttribute("theme","dark"),c.setAttribute("theme","dark")}let d=new ht;l.contract_instance=d.value,c.contract_instance=d.value,e.deploy_contract.addEventListener("click",(()=>{s.setAttribute("visible","true")})),s.addEventListener("contract-deployed",(()=>{d.value=s.contract_instance,console.log("A contract deployed, the contract_instance == ",s.contract_instance),l.contract_instance=d.value,c.contract_instance=d.value})),e.compile_deploy_contract.addEventListener("click",(()=>{a.setAttribute("visible","true")})),a.addEventListener("contract-deployed",(()=>{d.value=a.contract_instance,console.log("A contract deployed, the contract_instance == ",a.contract_instance),l.contract_instance=d.value,c.contract_instance=d.value})),e.create_subscription_product.addEventListener("click",(()=>{l.setAttribute("visible","true")})),l.addEventListener("subscription-product-created",(()=>{console.log("The subscription product created with ID == ",l.productID)})),e.subscribe.addEventListener("click",(()=>{c.setAttribute("visible","true")})),c.addEventListener("subscription-created",(()=>{console.log("The subscription created")})),e.menu.button.addEventListener("click",(()=>{e.menu.tooltip.setAttribute("visible","false")}));let h={};e.menu.popover.login.setAttribute("login","true");const p=at.Init(e.summary.details,e.transactions.details,e.schedule.details,e.menu.popover.login,e.add_transaction,e.switch_chain,e.deposit_ethers,i,h);e.menu.popover.login.addEventListener("click",(()=>{e.menu.popover.content.removeAttribute("visible"),p()}));let u={gas_price:1,gas_limit:21e3},b=new ct;e.add_transaction.addEventListener("click",(()=>{e.add_transaction_tooltip.setAttribute("visible","false"),E(rt.add_transaction(6,[],b,u),o.content),o.window.setAttribute("visible","true")})),o.window.addEventListener("visible-changed",(t=>{if(!t.target.visible){const t=o.notification.querySelector("kor-notification-item");t&&t.removeAttribute("visible")}})),o.button.addEventListener("click",(()=>{if(nt.check_transaction_data(u,o.notification)&&(o.window.removeAttribute("visible"),console.log("The transaction's destination_address == ",u.destination_address),console.log("The transaction's amount == ",u.amount),u.destination_address&&u.amount>0)){const t={from:Moralis.User.current().get("ethAddress"),to:u.destination_address,value:u.amount*Math.pow(10,18),gasPrice:u.gas_price*Math.pow(10,9),gas:u.gas_limit};console.log("The transactionObject == ",t),h.metamask.eth.sendTransaction(t,((t,o)=>{if(console.log("The sendTransaction error == ",t),console.log("The sendTransaction result == ",o),!t){b.add(u.destination_address),E(it.success_notifications(["The transaction was sent and will be shown in the Transactions tab after processing"]),e.notification);e.notification.querySelector("kor-notification-item").setAttribute("visible","true")}let i={};Object.assign(i,u),u=i}))}}));let f={},g=new dt;const v=()=>{E(st.schedule_table(g,v),e.schedule.details)};v(),e.schedule.add_button.addEventListener("click",(()=>{E(rt.add_transaction(6,[],b,u),r.transactions_content),E(st.add_schedule(f),r.schedule_content),r.window.setAttribute("visible","true")})),r.window.addEventListener("visible-changed",(t=>{if(!t.target.visible){const t=r.notification.querySelector("kor-notification-item");t&&t.removeAttribute("visible")}})),r.button.addEventListener("click",(()=>{if(!nt.check_transaction_data(u,r.notification))return;if(!nt.check_schedule_data(f,r.notification))return;const t={transaction_data:u,schedule_data:f};g.add(t),r.window.removeAttribute("visible"),E(st.schedule_table(g,v),e.schedule.details);let o={};Object.assign(o,u),u=o,o={},Object.assign(o,f),f=o}));const m=nt.initMetamaskChainSwitch();return e.switch_chain.addEventListener("click",(()=>{m(1)})),e.deposit_ethers.addEventListener("click",(()=>{n.window.setAttribute("visible","true")})),n.button.addEventListener("click",(()=>{n.window.removeAttribute("visible"),h.matic.depositEther(parseFloat(n.value.value)*Math.pow(10,18),{from:Moralis.User.current().get("ethAddress"),gasPrice:10*Math.pow(10,9),gasLimit:2e5}).then((t=>{console.log("The deposit ethers response == ",t)}))})),fetch("https://webatix.github.io/test/smart-contract/deployed-instance.json").then((t=>{t.ok&&t.json().then((t=>{d.value=t,console.log("The fetched deployed contract instance == ",d.value)}))})),t})();document.addEventListener("DOMContentLoaded",(()=>{Moralis.initialize("pnj2ou0ivNkr2xnWIQIKZjwhcbJgC6hO69CasCTS"),Moralis.serverURL="https://kcmeib0ovv6c.moralis.io:2053/server";const t=document.getElementsByTagName("body")[0];t.removeChild(document.getElementById("startupContent")),t.appendChild(St.tmpl)}));
