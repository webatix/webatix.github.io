...
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const B=(e,...t)=>new v(e,t,"html",E);var T={tab_strip_view:(e,t,o)=>B`
      ...
      </kor-grid>`},A={Init(e,t,o,n,r,i,s){const c=i.querySelector("div"),a=e=>{z(T.object_entries_two_columns_view(Object.entries(e.attributes)),c),i.setAttribute("visible","true")},l=async e=>{const o=new Moralis.Query("EthTransactions");o.equalTo("to_address",e.get("ethAddress"));const n=new Moralis.Query("EthTransactions");n.equalTo("from_address",e.get("ethAddress"));let r=await o.find();console.log("Incoming transactions: ",r);let i=await n.find();console.log("Out coming transactions: ",i),z(T.transactions_view(r,i,a),t);const c=await o.subscribe(),l=await n.subscribe();c.on("create",(e=>{console.log("A new incoming transaction: ",e),r=r.concat(e),z(T.transactions_view(r,i,a),t)})),l.on("create",(e=>{console.log("A new out coming transaction: ",e),i=i.concat(e),z(T.transactions_view(r,i,a),t)})),s=await Moralis.Web3.enable(),console.log("web3 == ",s)};return()=>{if(!n.getAttribute("login"))return Moralis.LiveQuery.close(),(async()=>{await Moralis.User.logOut(),z(B``,e),z(B``,t),z(B``,o),console.log("Logged out")})(),n.setAttribute("label","Login using Metamask"),n.setAttribute("login","true"),void(r.style.display="none");Moralis.Web3.authenticate().then((t=>{n.setAttribute("label","Log out"),n.removeAttribute("login"),r.style.display="block",z(T.object_entries_two_columns_view(Object.entries(t)),e),console.log("The current user: ",t),console.log("The current user password: ",t.password),console.log("The current user's EthAddress: ",t.get("ethAddress")),Moralis.Cloud.run("watchEthAddress",{address:t.get("ethAddress")}).then((e=>{console.log("The watchEthAddress results: ",e),l(t)})).catch((()=>{l(t)}))}))}}};const D=(()=>{const e={tmpl:document.getElementById("appTemplate").content},t=e.tmpl.querySelector("kor-page"),o=e.tmpl.getElementById("summaryContent"),n=e.tmpl.getElementById("summaryDetails"),r=e.tmpl.getElementById("transactionsContent"),i=e.tmpl.getElementById("scheduleContent");e.tmpl.querySelector("kor-app-bar");const s=e.tmpl.getElementById("appMenu"),c=e.tmpl.getElementById("appMenuPopover"),a=e.tmpl.getElementById("appMenuTooltip"),l=e.tmpl.getElementById("loginMenuItem");e.tmpl.getElementById("prefsMenuItem");const h=e.tmpl.getElementById("addTransaction"),d=e.tmpl.getElementById("addTransactionModal"),p=d.querySelector("kor-button"),b=d.querySelectorAll("kor-input"),f=e.tmpl.getElementById("addTransactionTooltip"),u=e.tmpl.getElementById("transactionDetailsModal"),g=e.tmpl.querySelector("kor-tabs");z(T.tab_strip_view(o,r,i),g),e.tmpl.getElementById("summaryTab"),e.tmpl.getElementById("transactionsTab"),e.tmpl.getElementById("scheduleTab"),t&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(t.setAttribute("theme","dark"),d.setAttribute("theme","dark"),u.setAttribute("theme","dark")),h.addEventListener("click",(()=>{f.setAttribute("visible","false"),d.setAttribute("visible","true")})),s.addEventListener("click",(()=>{a.setAttribute("visible","false")}));l.setAttribute("login","true");const v=A.Init(n,r,i,l,h,u,{});return l.addEventListener("click",(()=>{c.removeAttribute("visible"),v()})),p.addEventListener("click",(()=>{d.setAttribute("visible","false"),b[0].value&&b[1].value})),e})();document.addEventListener("DOMContentLoaded",(()=>{Moralis.initialize("pnj2ou0ivNkr2xnWIQIKZjwhcbJgC6hO69CasCTS"),Moralis.serverURL="https://kcmeib0ovv6c.moralis.io:2053/server";const e=document.getElementsByTagName("body")[0];e.removeChild(document.getElementById("startupContent")),e.appendChild(D.tmpl)}));
