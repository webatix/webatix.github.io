 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const E=new class{handleAttributeExpressions(e,t,o,n){const r=t[0];if("."===r){return new O(e,t.slice(1),o).parts}if("@"===r)return[new $(e,t.slice(1),n.eventContext)];if("?"===r)return[new k(e,t.slice(1),o)];return new _(e,t,o).parts}handleTextExpression(e){return new w(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const B=(e,...t)=>new v(e,t,"html",E);var T={tab_strip_view:(e,t,o)=>B`
      ...
      </kor-grid>`},A={Init(e,t,o,n,r,i,s){const c=i.querySelector("div"),a=e=>{z(T.object_entries_two_columns_view(Object.entries(e.attributes)),c),i.setAttribute("visible","true")},l=async e=>{const o=new Moralis.Query("EthTransactions");o.equalTo("to_address",e.get("ethAddress"));const n=new Moralis.Query("EthTransactions");n.equalTo("from_address",e.get("ethAddress"));let r=await o.find();console.log("Incoming transactions: ",r);let i=await n.find();console.log("Out coming transactions: ",i),z(T.transactions_view(r,i,a),t);const c=await o.subscribe(),l=await n.subscribe();c.on("create",(e=>{console.log("A new incoming transaction: ",e),r=r.concat(e),z(T.transactions_view(r,i,a),t)})),l.on("create",(e=>{console.log("A new out coming transaction: ",e),i=i.concat(e),z(T.transactions_view(r,i,a),t)})),s.web3=await Moralis.Web3.enable(),console.log("web3 == ",s.web3)};return()=>{if(!n.getAttribute("login"))return Moralis.LiveQuery.close(),(async()=>{await Moralis.User.logOut(),z(B``,e),z(B``,t),z(B``,o),console.log("Logged out")})(),n.setAttribute("label","Login using Metamask"),n.setAttribute("login","true"),void(r.style.display="none");Moralis.Web3.authenticate().then((t=>{n.setAttribute("label","Log out"),n.removeAttribute("login"),r.style.display="block",z(T.object_entries_two_columns_view(Object.entries(t)),e),console.log("The current user: ",t),console.log("The current user password: ",t.password),console.log("The current user's EthAddress: ",t.get("ethAddress")),Moralis.Cloud.run("watchEthAddress",{address:t.get("ethAddress")}).then((e=>{console.log("The watchEthAddress results: ",e),l(t)})).catch((()=>{l(t)}))}))}}};const D=(()=>{const e={tmpl:document.getElementById("appTemplate").content},t={content:e.tmpl.querySelector("kor-page"),top_bar:e.tmpl.querySelector("kor-app-bar"),menu:{button:e.tmpl.getElementById("appMenu"),tooltip:e.tmpl.getElementById("appMenuTooltip"),popover:{content:e.tmpl.getElementById("appMenuPopover"),login:e.tmpl.getElementById("loginMenuItem"),prefs:e.tmpl.getElementById("prefsMenuItem")}},add_transaction:e.tmpl.getElementById("addTransaction"),add_transaction_tooltip:e.tmpl.getElementById("addTransactionTooltip"),summary:{content:e.tmpl.getElementById("summaryContent"),details:e.tmpl.getElementById("summaryDetails")},transactions_content:e.tmpl.getElementById("transactionsContent"),schedule_content:e.tmpl.getElementById("scheduleContent"),tab_strip:e.tmpl.querySelector("kor-tabs")},o={window:e.tmpl.getElementById("addTransactionModal"),address:e.tmpl.getElementById("addTransactionModalAddress"),amount:e.tmpl.getElementById("addTransactionModalAmount"),button:e.tmpl.getElementById("addTransactionModalButton")},n=e.tmpl.getElementById("transactionDetailsModal");z(T.tab_strip_view(t.summary.content,t.transactions_content,t.schedule_content),t.tab_strip),t.content&&window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(t.content.setAttribute("theme","dark"),o.window.setAttribute("theme","dark"),n.setAttribute("theme","dark")),t.add_transaction.addEventListener("click",(()=>{t.add_transaction_tooltip.setAttribute("visible","false"),o.window.setAttribute("visible","true")})),t.menu.button.addEventListener("click",(()=>{t.menu.tooltip.setAttribute("visible","false")}));let r={};t.menu.popover.login.setAttribute("login","true");const i=A.Init(t.summary.details,t.transactions_content,t.schedule_content,t.menu.popover.login,t.add_transaction,n,r);return t.menu.popover.login.addEventListener("click",(()=>{t.menu.popover.content.removeAttribute("visible"),i()})),o.button.addEventListener("click",(()=>{if(o.window.removeAttribute("visible"),o.address.value&&o.amount.value){const e={from:Moralis.User.current().get("ethAddress"),to:o.address.value,value:o.amount.value};r.web3.eth.sendTransaction(e,((e,t)=>{console.log("The sendTransaction error == ",e),console.log("The sendTransaction result == ",t)}))}})),e})();document.addEventListener("DOMContentLoaded",(()=>{Moralis.initialize("pnj2ou0ivNkr2xnWIQIKZjwhcbJgC6hO69CasCTS"),Moralis.serverURL="https://kcmeib0ovv6c.moralis.io:2053/server";const e=document.getElementsByTagName("body")[0];e.removeChild(document.getElementById("startupContent")),e.appendChild(D.tmpl)}));
